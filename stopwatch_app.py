...
from PyQt5.QtWidgets import QApplication , QDialog , QPushButton , QLabel ,QTextBrowser 
...
class stopwatch_gui (QDialog):
    ...
    def buttons (self):
        ...
        self.b5 = QPushButton("Clear",self)
        self.b5.setToolTip("Clear lap results")
        self.b5.move(500,55)
        self.b5.clicked.connect(self.clear_action)
